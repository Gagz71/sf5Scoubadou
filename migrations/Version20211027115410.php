 ...
 */
final class Version20211027115410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, advertiser_id INT NOT NULL, title VARCHAR(255) NOT NULL, dogs_nb INT DEFAULT NULL, creation_date DATE NOT NULL, update_date DATE DEFAULT NULL, status TINYINT(1) NOT NULL, description VARCHAR(1000) DEFAULT NULL, url_picture VARCHAR(255) DEFAULT NULL, INDEX IDX_54F1F40BBA2FCBC2 (advertiser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dog (id INT AUTO_INCREMENT NOT NULL, advert_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, antecedents VARCHAR(255) DEFAULT NULL, lof TINYINT(1) NOT NULL, full_description VARCHAR(255) DEFAULT NULL, sociable TINYINT(1) DEFAULT NULL, is_adopted TINYINT(1) NOT NULL, url_picture VARCHAR(255) DEFAULT NULL, INDEX IDX_812C397DD07ECCB6 (advert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, register_date DATETIME NOT NULL, discr VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
